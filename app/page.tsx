...
export default function Sudoku() {
  ...
  useEffect(() => {
    if (!attempt || attempt.completedAt !== null) return;
    ...
    <main className={screen === 'play' || screen === 'review' ? 'board-screen' : ''}>
      ...
      {screen === 'detail' && puzzle ? (
        <section className="library">
          ...
          <p className="storage-note">
            Duration is elapsed time from starting to finishing, including time away. Completed
            attempts remain available to replay.
          </p>
        </section>
      ) : null}
